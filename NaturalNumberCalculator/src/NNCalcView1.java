...
public final class NNCalcView1 extends JFrame implements NNCalcView {
    ...
    public NNCalcView1() {
         ...
         */
        super("Natural Number Calculator: Logan Wiest");
        ...
        //Main buttons (operations and operands)
        ...
        //Initialize bDigits JButton before implementing for loop
        ...
        //When opening program, 0 should be both top and bottom
        this.tTop.setText("0");
    ...
    public void updateSubtractAllowed(boolean allowed) {
        if (allowed) {
            ...
            //Make sure to make subtract unusable if it does not meet preconditions
        } else {
    ...
    public void updateDivideAllowed(boolean allowed) {
        if (allowed) {
            ...
            //Make sure to make divide unusable if it does not meet preconditions
        } else {
            this.bDivide.setEnabled(false);
        }
    }
    ...
    public void updatePowerAllowed(boolean allowed) {
        if (allowed) {
            ...
            //Make sure to make power unusable if it does not meet preconditions
        } else {
    ...
    public void updateRootAllowed(boolean allowed) {
        if (allowed) {
            ...
            //Make sure to make root unusable if it does not meet preconditions
        } else {
            this.bRoot.setEnabled(false);
        }
    }
